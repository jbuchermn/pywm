...
* Development
** Current (v0.2)
*** STRT Export XCURSOR_THEME, XCURSOR_SIZE
*** STRT Set cursor position from python
...
*** TODO Try some optimizations of update loop if no state (view nor layout nor widget) changes (most common case)
