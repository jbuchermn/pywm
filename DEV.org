...
*** DONE Export XCURSOR_THEME, XCURSOR_SIZE
*** DONE Set cursor position from python
*** STRT Try some optimizations of update loop if no state (view nor layout nor widget) changes (most common case)
