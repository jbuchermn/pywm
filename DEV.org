...
*** DONE Bug: XWayland views don't receive mouse events if output isn't placed at 0, 0
*** STRT Bug: XWayland popups (Firefox > Import bookmarks, Firefox > Save as) do not receive mouse events
*** TODO Set cursor position from python
