...
**** STRT Feedback loop wm_callback_update is too slow
   ...
   - Issue: Frame drops don't happen in direct or passthrough render modes, only in indirect
        ...
        - mostly with lots of adjacent terminals, which produce complicated wm_compose_tree (possibility to have wm_composites on same z-index and therefore not influence each other)
