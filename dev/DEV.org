...
* Development
** Current (v0.3)
*** STRT Updates are lost on map (if size negotiation fails? or only xwayland?)
*** STRT Artifacts on view corners
*** STRT place three alacrittys, open e.g. imv - artifacts on blur
